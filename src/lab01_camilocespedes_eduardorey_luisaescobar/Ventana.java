...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Explorador archivos");
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton4ActionPerformed(evt);
            }
        });
        panelDeBusqueda2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, -1, -1));
    ...
    private void buscarPostActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void buscarUserActionPerformed(java.awt.event.ActionEvent evt) {                                           
        infoUsuario.setText("");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        for (User user : As.getUsers()) {
            fileCreatorU(As.BuscarUsuario(user.getId()));
        }
        try {
            fileChooserEvent();
    ...
    public void fileCreatorU(NodoUser nodo) {
        String dir = "FileChooser\\" + nodo.getId();
        File c = new File(dir);
        c.mkdirs();
        ...
        try {
            ...
            pw.println("Id: " + nodo.getId()
                    + "\nName: " + nodo.getName()
                    + "\nUsername: " + nodo.getUserName()
                    + "\nPhone: " + nodo.getPhone()
                    + "\nEmail: " + nodo.getEmail()
                    + "\nWebsite: " + nodo.getWebSite());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
        ...
        try {
            c = new File(dir + "\\Address");
            c.mkdirs();
            f = new File(dir + "\\Address\\Info.txt");
            fichero = new FileWriter(f);
            pw = new PrintWriter(fichero);

            pw.println("Street: " + nodo.getAddress().getStreet()
                    + "\nSuite: " + nodo.getAddress().getSuite()
                    + "\nCity: " + nodo.getAddress().getCity()
                    + "\nZip code: " + nodo.getAddress().getZipCode());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
        ...
        try {
            c = new File(dir + "\\Address\\geo");
            c.mkdirs();
            f = new File(dir + "\\Address\\geo\\Info.txt");
            fichero = null;
            pw = null;
            ...
            pw.println("Lat: " + nodo.getAddress().getGeo().getLatitud()
                    + "\nLng: " + nodo.getAddress().getGeo().getLongitud());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
        ...
        try {
            c = new File(dir + "\\Company");
            c.mkdirs();
            f = new File(dir + "\\Company\\Info.txt");
            fichero = null;
            pw = null;
            ...
            pw.println("Name: " + nodo.getCompany().getName()
                    + "\nCatchPhrase: " + nodo.getCompany().getCatchPhrase()
                    + "\nBs: " + nodo.getCompany().getBs());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
        ...
        c = new File(dir);
        c.mkdirs();
        for (NodoPost nodoPost : nodo.getNodosP()) {
            fileCreatorP(nodoPost, dir);
        }
    }

    public void fileCreatorP(NodoPost nodo, String dir) {
        dir = dir + "\\" + nodo.getId();
        File c = new File(dir);
        c.mkdirs();
        File f = new File(dir + "\\Info.txt");
        ...
        try {
            ...
            pw.println("UserId: " + nodo.getUserID()
                    + "\nId: " + nodo.getId()
                    + "\nTitle: " + nodo.getTittle()
                    + "\nBody: " + nodo.getBody());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
        ...
        c = new File(dir);
        c.mkdirs();
        for (NodoComment nodoComment : nodo.getNodosC()) {
            fileCreatorC(nodoComment, dir);
        }
    }

    public void fileCreatorC(NodoComment nodo, String dir) {
        dir = dir + "\\" + nodo.getId();
        File c = new File(dir);
        c.mkdirs();
        File f = new File(dir + "\\Info.txt");
        ...
        try {
            ...
            pw.println("PostId: " + nodo.getPostID()
                    + "\nId: " + nodo.getId()
                    + "\nName: " + nodo.getName()
                    + "\nEmail: " + nodo.getEmail()
                    + "\nBody: " + nodo.getBody());
    ...
    public void fileChooserEvent() throws IOException {
        String dir = "FileChooser\\";
